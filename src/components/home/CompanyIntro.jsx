...
export default function CompanyIntro() {
  ...
  return (
    <section className="bg-teal-50 p-8 rounded shadow-md max-w-4xl mx-auto mb-8">
      <h1 className="text-3xl font-bold text-teal-800 mb-4">Welcome to Our Company</h1>
      <p className="text-teal-700 mb-2">{company.intro}</p>
      <p className="text-teal-900 font-semibold">
        Contact us at: {company.contact_email} | {company.phone_number}
      </p>
      <p className="text-teal-700">{company.address}</p>
    </section>
  );
}
